...
var arrayWithHoles = require('@babel/runtime/helpers/esm/arrayWithHoles');
var iterableToArrayLimit = require('@babel/runtime/helpers/esm/iterableToArrayLimit');
var unsupportedIterableToArray = require('@babel/runtime/helpers/esm/unsupportedIterableToArray');
var nonIterableRest = require('@babel/runtime/helpers/esm/nonIterableRest');
...
var defineProperty = require('@babel/runtime/helpers/esm/defineProperty');
...
var arrayWithHoles__default = /*#__PURE__*/_interopDefaultLegacy(arrayWithHoles);
var iterableToArrayLimit__default = /*#__PURE__*/_interopDefaultLegacy(iterableToArrayLimit);
var unsupportedIterableToArray__default = /*#__PURE__*/_interopDefaultLegacy(unsupportedIterableToArray);
var nonIterableRest__default = /*#__PURE__*/_interopDefaultLegacy(nonIterableRest);
var defineProperty__default = /*#__PURE__*/_interopDefaultLegacy(defineProperty);

function _slicedToArray(arr, i) {
  return arrayWithHoles__default['default'](arr) || iterableToArrayLimit__default['default'](arr, i) || unsupportedIterableToArray__default['default'](arr, i) || nonIterableRest__default['default']();
}
  ...
  for (var i = 1; i < arguments.length; i++) {
    ...
    if (i % 2) {
      ownKeys(Object(source), true).forEach(function (key) {
        defineProperty__default['default'](target, key, source[key]);
      });
...
}, _defineProperty(_props$data$mounted$c, vueDemi.isVue3 ? 'unmounted' : 'destroyed', function () {
  this.unobserve();
